<template>
	...
	<ion-modal v-if="settings.data?.allow_employee_checkin_from_mobile_app" ref="modal" trigger="open-checkin-modal"
		...
		<div class="h-120 w-full flex flex-col items-center justify-center gap-5 p-4 mb-5">
			...
			<!-- New Button Added -->
			<!-- <Button variant="outline" class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded text-center" :href="`/capture-image/new`" target="_blank">
					{{ __("Capture Image") }}
				</Button> -->
	
			<a href="/capture-image/new"
				class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded text-center">
				Capture Image
			</a>
